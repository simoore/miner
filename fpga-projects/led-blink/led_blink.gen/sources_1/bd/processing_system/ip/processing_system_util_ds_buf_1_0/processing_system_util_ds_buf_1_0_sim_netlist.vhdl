...
-- Date        : Mon Aug  7 23:43:39 2023
-- Host        : DESKTOP-6IBO5D3 running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               d:/doc/dev/led_blink/led_blink.gen/sources_1/bd/processing_system/ip/processing_system_util_ds_buf_1_0/processing_system_util_ds_buf_1_0_sim_netlist.vhdl
-- Design      : processing_system_util_ds_buf_1_0
...
entity processing_system_util_ds_buf_1_0_util_ds_buf is
  port (
  ...
  attribute C_BUFGCE_DIV of processing_system_util_ds_buf_1_0_util_ds_buf : entity is 1;
  attribute C_BUFG_GT_SYNC : integer;
  attribute C_BUFG_GT_SYNC of processing_system_util_ds_buf_1_0_util_ds_buf : entity is 0;
  attribute C_BUF_TYPE : string;
  attribute C_BUF_TYPE of processing_system_util_ds_buf_1_0_util_ds_buf : entity is "IBUFDS";
  attribute C_MODE : string;
  attribute C_MODE of processing_system_util_ds_buf_1_0_util_ds_buf : entity is "PERFORMANCE";
  attribute C_OBUFDS_GTE5_ADV : string;
  attribute C_OBUFDS_GTE5_ADV of processing_system_util_ds_buf_1_0_util_ds_buf : entity is "2'b00";
  attribute C_REFCLK_ICNTL_TX : string;
  attribute C_REFCLK_ICNTL_TX of processing_system_util_ds_buf_1_0_util_ds_buf : entity is "5'b00000";
  attribute C_SIM_DEVICE : string;
  attribute C_SIM_DEVICE of processing_system_util_ds_buf_1_0_util_ds_buf : entity is "VERSAL_AI_CORE_ES1";
  attribute C_SIZE : integer;
  attribute C_SIZE of processing_system_util_ds_buf_1_0_util_ds_buf : entity is 2;
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of processing_system_util_ds_buf_1_0_util_ds_buf : entity is "util_ds_buf";
end processing_system_util_ds_buf_1_0_util_ds_buf;

architecture STRUCTURE of processing_system_util_ds_buf_1_0_util_ds_buf is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity processing_system_util_ds_buf_1_0 is
  port (
    IBUF_DS_P : in STD_LOGIC_VECTOR ( 1 downto 0 );
    IBUF_DS_N : in STD_LOGIC_VECTOR ( 1 downto 0 );
    IBUF_OUT : out STD_LOGIC_VECTOR ( 1 downto 0 )
  ...
  attribute NotValidForBitStream of processing_system_util_ds_buf_1_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of processing_system_util_ds_buf_1_0 : entity is "processing_system_util_ds_buf_1_0,util_ds_buf,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of processing_system_util_ds_buf_1_0 : entity is "yes";
  attribute x_core_info : string;
  attribute x_core_info of processing_system_util_ds_buf_1_0 : entity is "util_ds_buf,Vivado 2022.2";
end processing_system_util_ds_buf_1_0;

architecture STRUCTURE of processing_system_util_ds_buf_1_0 is
...
begin
U0: entity work.processing_system_util_ds_buf_1_0_util_ds_buf
     port map (
